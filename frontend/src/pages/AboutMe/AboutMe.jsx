		...
		<div className="container" >
			<form onSubmit={handleSubmit(onSubmit)}>
				<div className="row gutters">
					...
					{/* 
                    <div className="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12" style="display:none;" id="my-order">
                        <div className="card">
                            <div className="card-body">
                                <div className="row gutters pl-3">
                                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <h6 className="mb-2 text-primary">My Orders</h6>
                                    </div>
                                    <div>
                                            ...
                                            <c:forEach items="${orders}" var="c">
                                                <tr>
                                                    ...
                                                    <c:if test="${c.status != 'SUCC'}">
                                                        <td><a href="buy-again?id=${c.orderID}" style="pointer-events: none;"><i className="fa-sharp fa-solid fa-shop text-dark"></i></a></td>
                                                            </c:if>
                                                            <c:if test="${c.status == 'SUCC'}">
                                                        <td><a href="buy-again?id=${c.orderID}"><i className="fa-sharp fa-solid fa-shop text-dark"></i></a></td>
                                                            </c:if>
                                                </tr>
                                            </c:forEach>
                                ...
                                <div className="row">
                                    <div className="col-lg-12 text-center">
                                        <div className="pagination-wrap text-center">
                                            <ul className="d-flex text-center justify-content-center" style="margin-top: 20px">
                                                <c:forEach begin="1" end="${numberPage}" var="i">
                                                    <li style="list-style: none"><a style="border: 1px solid black; border-radius: 50%" className="m-3 text-dark text-decoration-none px-2 py-1" href="UpdateAccountServlet?index=${i}">${i}</a></li>
                                                    </c:forEach>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div className="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12" style="display:none;" id="my-feedback">
                        <div className="card">
                            <div className="card-body">
                                <div className="row gutters pl-3">
                                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <h6 className="mb-2 text-primary">My Feedbacks</h6>
                                    </div>
                                    <div>
                                        <table id="my-order-list">
                                            <tr>
